...
public class SellerAgent extends Agent {
		...
		public void action() {
			...
			if(msg != null) {
				...
				if(msg.getContent().equals("new day")) {
					...
					CyclicBehaviour ps = new PurchaseServer();
					myAgent.addBehaviour(ps);
					ArrayList<Behaviour> cyclicBehaviours = new ArrayList<>();
					cyclicBehaviours.add(os);
					cyclicBehaviours.add(ps);
	...
	public class PurchaseServer extends CyclicBehaviour{
		public void action(){
			...
			if(msg != null) {
				...
				if(booksForSale.containsKey(msg.getConversationId())) {
					reply.setContent("purchase successful");
					System.out.println("Agent " + myAgent.getName() + " has sold book " + msg.getConversationId() + ".");
				} else {
					reply.setContent("purchase unsuccessful");
				}
				myAgent.send(reply);
			}else {
				block();
